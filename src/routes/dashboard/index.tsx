    ...
    <div className="max-w-6xl mx-auto space-y-20 py-8 px-4 sm:px-6">
      ...
      <section className="text-center space-y-6 max-w-4xl mx-auto">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-6xl font-extrabold tracking-tight leading-tight bg-clip-text text-transparent bg-gradient-to-r from-foreground via-foreground to-brand dark:to-accent"
        >
