    ...
    try {
      ...
      toast.error("Analysis failed", {
        description:
          ...
          "There was an error running your compliance query.",
      });
    }
  };
  ...
  return (
    <div className="flex flex-col xl:flex-row gap-6 max-w-[1400px] mx-auto pb-10">
                      ...
                      (analysis?.penalties as any)?.penalties || [
                        {
                          ...
                          penalty:
                            "10% credit of monthly fee per 0.1% below SLA",
                        },
                        {
                          type: "Data Breach",
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  {(
                    (analysis?.compliance_requirements as any)
                      ?.requirements || [
                      {
                        regulation: "GDPR",
            ...
            <CardContent className="space-y-4">
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  disabled={analyzeMutation.isPending || !newQuery.trim()}
                >
      ...
      <div className="w-full xl:w-[400px] shrink-0 space-y-4">
        <div className="sticky top-6 flex flex-col h-[calc(100vh-100px)] border rounded-xl bg-card/50 backdrop-blur shadow-sm">
          <div className="p-4 border-b flex items-center gap-2 bg-muted/30 rounded-t-xl">
            <MessageSquare className="h-5 w-5 text-brand" />
            <h3 className="font-semibold text-sm">AI Compliance Chat</h3>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-6">
            {queries?.length === 0 ? (
              <div className="text-center space-y-2 mt-10">
                ...
                <p className="text-xs text-muted-foreground">
                  Ask the AI about specific clauses, risks, or compliance issues
                  in this document.
                </p>
              </div>
            ) : (
              queries?.map((query: any) => (
                <div key={query.id} className="space-y-4">
                  ...
                  <div className="flex justify-start">
                    <div className="bg-muted rounded-2xl rounded-tl-sm px-4 py-3 max-w-[90%] text-sm shadow-sm space-y-3">
                        ...
                        <>
                          <div className="flex items-center gap-2 mb-2">
                            <Badge
                              ...
                              className="text-[10px]"
                            >
                              {query.response?.AnalysisResult?.overallVerdict?.toUpperCase() ||
                                "UNKNOWN"}
                            </Badge>
                          </div>
                          <p className="leading-relaxed">
                            {query.response?.AnalysisResult?.summary ||
                              "Analysis complete. See findings below."}
                          </p>
                          {query.response?.AnalysisResult?.findings?.length >
                            0 && (
                            <div className="space-y-2 mt-3 pt-3 border-t border-border/50">
                              <p className="text-xs font-semibold text-muted-foreground">
                                Key Findings:
                              </p>
                              {query.response.AnalysisResult.findings
                                .slice(0, 3)
          ...
          <div className="p-3 border-t bg-muted/10 rounded-b-xl">
            ...
            >
              <Textarea
                ...
                className="min-h-[60px] resize-none pr-12 text-sm bg-background border-muted"
                onKeyDown={(e) => {
              ...
              <Button
                type="submit"
                size="icon"
                disabled={!newQuery.trim() || analyzeMutation.isPending}
